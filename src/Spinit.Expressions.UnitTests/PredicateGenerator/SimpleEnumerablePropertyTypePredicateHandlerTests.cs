...
{
    public class SimpleEnumerablePropertyTypePredicateHandlerTests
    {
        public class CanHandle
        {
            [Theory]
            [MemberData(nameof(GetPropertyNames), typeof(FilterWithSimpleEnumerableProps), MemberType = typeof(SimpleEnumerablePropertyTypePredicateHandlerTests))]
            ...
            [Theory]
            [MemberData(nameof(GetPropertyNames), typeof(FilterWithNonSimpleEnumerableProps), MemberType = typeof(SimpleEnumerablePropertyTypePredicateHandlerTests))]
